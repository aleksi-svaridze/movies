      ...
      <div className="flex items-center gap-x-6">
        {width < 768 ? (
          <NavLink to={"/"} className="cursor-pointer size-4">
            {({ isActive }) => <MainMenuIcon isActive={isActive} />}
          </NavLink>
        ) : (
          <NavLink to={"/"} className="cursor-pointer size-5">
            {({ isActive }) => <MainMenuIconDesktop isActive={isActive} />}
          </NavLink>
        )}
        ...
        {width < 768 ? (
          ...
          <NavLink to={"/movies"} className="cursor-pointer size-5">
            {({ isActive }) => <MoviesIconDesktop isActive={isActive} />}
          </NavLink>
        )}
        ...
        {width < 768 ? (
          ...
          <NavLink to={"/tvseries"} className="cursor-pointer size-5">
            {({ isActive }) => <TvSeriesIconDesktop isActive={isActive} />}
          </NavLink>
        )}

        {width < 768 ? (
          <NavLink to={"/bookmarked"} className="cursor-pointer w-[14px] h-4">
            {({ isActive }) => <BookmarkedIcon isActive={isActive} />}
          </NavLink>
        ) : (
          <NavLink to={"/bookmarked"} className="cursor-pointer w-[17px] h-5">
            {({ isActive }) => <BookmarkedIconDesktop isActive={isActive} />}
          </NavLink>
        )}
      </div>
...
export const DesktopHeader = () => {
  return (
    <div
      className="hidden rounded-[20px] bg-semidark-blue lg:fixed w-24 lg:flex flex-col items-center justify-between pt-9 pb-8"
